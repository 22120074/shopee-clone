    ...
    <div className="w-full max-w-[1200px] relative">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2 p-2 w-full">
        {products &&
          products.map((product, index) => (
            <div
              key={product.id}
              className="group flex flex-col h-[300px] relative 
            ...
            >
              ...
              >
                ...
                <div className="w-full flex flex-col justify-between px-2 flex-1">
                  <p
                    className="text-[14px] leading-[18px] text-start mt-[10px] overflow-hidden 
                            h-[36px] line-clamp-2"
                  >
                    {product.favorite && (
                      <span
                        className="inline-block text-white text-[11px] bg-primaryTextColor 
              ...
              <div
                className="h-[35px] text-[15px] text-white bg-primaryTextColor border border-primaryTextColor 
                    rounded-b-[3px] absolute top-[100%] left-0 right-0 z-10 opacity-0 
                    transition-all duration-100 ease-in-out 
                    group-hover:opacity-100 group-hover:translate-y-0"
              >
                <Link
                  to={`/product/find_similar_item/${product.name}`}
      ...
      <div className="w-full flex items-center justify-center mt-10">
        <Link
          ...
          className="w-[380px] h-[40px] bg-[white] 
