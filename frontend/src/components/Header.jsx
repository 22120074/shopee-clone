...
function Header() {
    ...
    return (
        <header className={`${isSticky ? 'sticky top-0 z-[30]' : 'relative'} Web-header flex flex-col bg-primaryColor
                        ...
                        <div className='flex h-full w-auto items-center '>
                            <Link to="/" className="flex items-center text-primaryColor" style={{ textDecoration: "none", height: "100%", fontSize: "24px", fontWeight: "400" }}>
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" 
                                    className="text-primaryColor translate-y-[-6px]" style={{ height: "47px", width: "50px"}}>
