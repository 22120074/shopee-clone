        ...
        <div className="navbar flex items-center justify-between" style={{ height: "32px", width: "100%", maxWidth: "1200px", margin: "0 auto" }}>
            ...
            <ul className="flex flex-row items-center">
                ...
                <li className="text-sm text-white" style={{ margin: "0 8px 0 16px"}}>
                    <ul className="flex flex-row items-center">
                        <li className="li_borderleft" style={{ padding: "0 9px 0 0", position: "relative"}}>Đăng Kí</li>
                        <li className="" style={{ padding: "0 0 0 8px" }}>Đăng Nhập</li>
                    </ul>
                </li>
            </ul>
        </div>

        <div className="main_navbar flex items-center justify-center" style={{ height: "88px", width: "100%", maxWidth: "1200px", margin: "0 auto" }}>
            <div style={{ marginRight: "50px", height: "100%" }}>
                <a href="/" className="flex items-center" style={{ textDecoration: "none", color: "white", height: "100%", fontSize: "32px", fontWeight: "400" }}>
            ...
            <div className="flex items-center" style={{ flex: "1", height: "100%" }}>
