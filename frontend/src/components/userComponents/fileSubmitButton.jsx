...
function FileSubmitButton({ addToast }) {
  ...
  const handleFile = (file) => {
    ...
    if (!validTypes.includes(file.type)) {
      addToast(
        "Vui lòng chọn tệp ảnh hợp lệ (JPEG, PNG, GIF)",
        "error",
        "warning",
      );
    ...
    if (file.size > maxSize) {
      addToast(
        "Kích thước tệp quá lớn. Vui lòng chọn tệp nhỏ hơn 1MB.",
        "error",
        "warning",
      );
      fileInputRef.current.value = null;
        ...
        <div className="fixed inset-0 z-20">
          ...
          >
            <div className="w-full border-b border-lesslessgrayColor pb-4">
              ...
              <div className="text-base text-moregrayTextColor font-medium">
                Nhập Url hoặc tải ảnh bạn thích từ thiết bị của mình
              </div>
            </div>
            {/* Nơi Drag và Drop hoặc Chọn tệp bằng Button */}
            <div
              className="relative border-2 border-dashed border-lessgrayColor bg-backgroundLightGrayColor
               rounded-md w-full h-60 mt-4
            ...
            >
              ...
              <label
                className="bg-blueButton text-white px-6 py-2 rounded-md cursor-pointer"
            ...
            <div className="w-full flex items-center justify-between mb-2 gap-2">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <button
                  className="bg-backgroundGrayColor text-black border border-black rounded-md px-6 h-10
