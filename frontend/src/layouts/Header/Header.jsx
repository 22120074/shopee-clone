  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="navbar_input-wrapper flex items-center lg:hidden max-w-[400px] md:max-w-[600px] lg:max-w-none w-full h-[32px] 
            bg-white pl-[10px]"
        >
          <input
            type="text"
            className="navbar_input w-full h-[32px] flex-1 text-sm placeholder:text-xs md:placeholder:text-sm"
        ...
        <ul className="flex flex-row items-center">
          <Link
            to="/cart"
            className="flex lg:hidden items-center h-full justify-center mr-8"
          >
            <i
              className="cursor-pointer w-[30%] flex items-center justify-center relative 
                      ...
                      <ul className="flex flex-col text-black">
                        <li className="user_dropdown-item hover:bg-gray-100 hover:text-hoverTextColorHeader">
                          <Link
                            ...
                            className="user_dropdown-item_link"
                          >
                            Tài khoản của tôi
                          </Link>
                        </li>
                        ...
                        <li
                          className="user_dropdown-item hover:bg-gray-100 hover:text-hoverTextColorHeader"
                          onClick={handleLogout}
                        >
                          <span className="user_dropdown-item_link">
                            Đăng xuất
                          </span>
                        </li>
                      </ul>
      ...
      {urlPath === "cart" ? (
        <div className="hidden lg:block bg-white w-full h-full border-b border-gray-200">
          <div className="flex items-center justify-between h-full mx-auto max-w-[1200px]">
            ...
            <div className="flex h-full w-auto items-center ">
              <Link
                to="/"
                className="flex items-center text-primaryColor no-underline h-full text-2xl font-normal"
              >
                <svg
                  role="img"
                  viewBox="0 0 24 24"
            ...
            <div className="h-full w-full max-w-[600px] flex items-center">
              <div
                className="navbar_input-wrapper_cart relative flex items-center w-full h-[40px] bg-white 
                                    border-2 border-primaryColor rounded-sm"
              >
                <input
                  type="text"
                  className="navbar_input text-sm w-full h-[20px] px-2"
        ...
        <div className="main_navbar hidden lg:flex items-center justify-center w-full max-w-[1200px] my-0 mx-auto">
          ...
          <div className="h-full mr-[50px] ">
            <Link
              to="/"
              className="flex items-center no-underline text-white h-full text-3xl font-normal"
            >
              <svg
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className="text-white h-[47px] w-[50px] mb-3"
              >
                <title>Shopee</title>
                <path
                  fill="currentColor"
          ...
          >
            <Link
              to="/cart"
              className="flex items-center w-[30%] h-full justify-center"
            >
              <i
                className="cursor-pointer w-[30%] flex items-center justify-center relative 
                                fa-solid fa-cart-shopping text-white"
            ...
            >
              ...
              {items.length === 0 ? (
                <div className="relative flex flex-col items-center justify-center h-full w-full">
                  ...
                  />
                  <div className="absolute bottom-[32px] text-[16px] text-gray-400 text-center capitalize">
                    chưa có sản phẩm nào
                  </div>
                </div>
              ) : (
                <div className="relative flex flex-col items-start justify-center h-full w-full pt-2 pb-3 px-3">
                  <h3 className="text-gray-400 text-[16px] mb-5">
                    Sản Phẩm Mới Thêm
                  </h3>
                  <ul className="flex flex-col w-full h-full overflow-y-auto gap-4">
                    {items.slice(0, 5).map((item) => (
                      <li
                        key={item.selectedAttributes.attribute.id}
