...
router.get("/me", noCacheMiddleware, protect, getMe);
...
router.post("/send-otp-email", noCacheMiddleware, sendOtpEmail);
router.post("/vertify-otp-email", noCacheMiddleware, vertifyOtpEmail);
